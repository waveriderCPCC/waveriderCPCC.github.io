function initCourseForm() {
  ...
  document.getElementById("form").addEventListener("submit", (e) => {
    ...
    o += `<figure style="float: right;">
            <img id="figure" src="images/driving.png" alt="${formData.get(
              "caption"
            )}">
    ...
    o += `<li><strong>Funny/Interesting Item to Remember Me by:</strong> ${formData.get(
      "funny"
    )}</li>`;
    o += `<li><strong>I’d Also Like to Share:</strong> ${formData.get(
      "extra"
    )}</li>`;
